...
pub struct Shared {
    ...
    /// Gamepad center-pad (PS/Mode button) press counter: the mount worker
    /// bumps it, the UI consumes it to cycle fullscreen camera views.
    pub fs_clicks: std::sync::atomic::AtomicU32,
...
impl Shared {
    ...
    pub fn new(config: Config, core: Arc<LoopShared>) -> Arc<Self> {
        ...
        Arc::new(Shared {
            ...
            fs_clicks: std::sync::atomic::AtomicU32::new(0),
